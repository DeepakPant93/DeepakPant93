...
- **[Report Genie](https://github.com/DeepakPant93/ReportGenie)** is an AI-driven report generation tool that automates the process of creating detailed and structured reports. Leveraging the power of **[CrewAI](https://www.crewai.com/)** for task delegation and **[Gradio](https://www.gradio.app/)** for an interactive user interface, this application streamlines report generation with minimal user input.
